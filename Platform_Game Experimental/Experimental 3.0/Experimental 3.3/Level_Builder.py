        ...
        if pygame.mouse.get_pressed()[2] == True: #Left Click and drag to draw
            if L.id == 1:
                ...
                if random.randint(0,100) < 20:
                    ...
                    if Rand <= 30:
                        Double[L.st] = C.Power_Ups("Jumps", random.randint(L.x, L.x1), L.y-33)
                    elif Rand <= 60 and Rand > 30:
                        Double[L.st] = C.Power_Ups("Speed", random.randint(L.x, L.x1), L.y-33)
                    elif Rand > 60:
                        Double[L.st] = C.Power_Ups("JumpBoost", random.randint(L.x, L.x1), L.y-33)
